...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear">
    ...
    <div class="one_third first">
      ...
      <ul class="faico clear" id="contenedorRedesS">
        <li><a class="faicon-facebook iconRedes" href="#"><i class="fa fa-facebook"></i></a></li>
        <li><a class="faicon-twitter iconRedes" href="#"><i class="fa fa-twitter"></i></a></li>
        <li><a class="faicon-google-plus iconRedes" href="#"><i class="fa fa-google-plus"></i></a></li>
